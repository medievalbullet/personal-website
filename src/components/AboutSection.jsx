    ...
    <section id='about-container'>
      <div id='about-main'>
        ...
        <div id='about-content'>
          ...
          <section className='about-section'>
            <h3 className='about-title slide-in-element' id='about-hobbies-title'><i className="material-icons about-icon">sports_esports</i>Hobbies & Interests</h3>
            <div className="separator-h"></div>
            <span className='about-text slide-in-element' id='about-hobbies-text'>
              I like:
              <ul>
